...
# ---------- AJUSTE CLAVE ----------
def asignar_turnos(df_recursos, duracion_min):
    """
    Genera bloques exactos de `duracion_min` minutos, mostrando el rango
    hh:mm - hh:mm (ej. 06:00 - 11:59 para un bloque de 6 horas).
    """
    resultados = []
    for fecha_idx in df_recursos.index:
        ...
        while i < len(horas_orden):
            ...
            end_min_tot = start_min_tot + duracion_min - 1  # minuto final incluido
